...
public class Constants {
	...
	public static double INTAKE_POT_OFFSET = prefs.getDouble("INTAKE_POT_OFFSET", -0.053);
	public static double INTAKE_POT_SHOOTING = prefs.getDouble("INTAKE_POT_SHOOTING", 0.497);
	public static double INTAKE_POT_HANGING = 0.55;
	public static double INTAKE_POT_POP = 0.567;
	public static double INTAKE_POT_DIE = 0.40;
	public static double INTAKE_POT_DEAD = 0.25;
	public static double INTAKE_POT_UP = 0.225;
...
//	public static double INTAKE_TOP_INTAKE_POWER = prefs.getDouble("INTAKE_TOP_INTAKE_POWER", 0.6);
//	public static double INTAKE_BOT_INTAKE_POWER = prefs.getDouble("INTAKE_BOT_INTAKE_POWER", 1);
...
//	public static double SHOOTER_SERVO_LEFT_IN = prefs.getDouble("SHOOTER_SERVO_LEFT_IN", 0.15);
	...
	//Magical speed
	public static double SHOOTER_FEEDER_IN = 1;
	public static double SHOOTER_FEEDER_OUT = -0.25;
...
//		INTAKE_TOP_INTAKE_POWER = prefs.getDouble("INTAKE_TOP_INTAKE_POWER", 0.6);
//		INTAKE_BOT_INTAKE_POWER = prefs.getDouble("INTAKE_BOT_INTAKE_POWER", 1);
