...
public class Constants {
	...
	public static final double INTAKE_POT_UP = 0.700;
	public static final double INTAKE_POT_DOWN = 0.03;
	public static final double INTAKE_POT_DEAD = 0.08;
	public static final double INTAKE_POT_INTAKE = 0.12;
