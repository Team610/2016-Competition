...
public class CameraServer610 {
	...
	private static CameraServer610 server;

	public static CameraServer610 getInstance() {
		if (server == null) {
			server = new CameraServer610();
		}
		return server;
	}
	...
	public void startAutomaticCapture() {
		startAutomaticCapture(USBCamera610.kDefaultCameraName);
	}
	...
	public void startAutomaticCapture(String cameraName) {
		try {
			USBCamera610 camera = new USBCamera610(cameraName);
			camera.openCamera();
	...
	public synchronized void startAutomaticCapture(USBCamera610 camera) {
		...
		m_camera.setWhiteBalanceManual(3000);
